<SystemCoupling Ver="1">
  <Participants Count="2">
    <Participant Ver="1" Type="0">
      ...
      <DisplayName PropType="string">Model, Transient</DisplayName>
    ...
    <Participant Ver="1" Type="0">
      ...
      <DisplayName PropType="string">Fluid Flow (CFX)</DisplayName>
      <ParticipantType PropType="string">CFX</ParticipantType>
      <SupportsCouplingIterations PropType="bool">True</SupportsCouplingIterations>
      <UnitSystem PropType="string">SI</UnitSystem>
      <Regions Count="2">
        <Region Ver="1">
          <Name PropType="string">Plate</Name>
          <DisplayName PropType="string">Plate</DisplayName>
          <TopologicalDimensionality PropType="int">3</TopologicalDimensionality>
        </Region>
        <Region Ver="1">
          <Name PropType="string">Wall</Name>
          <DisplayName PropType="string">Wall</DisplayName>
          <TopologicalDimensionality PropType="int">3</TopologicalDimensionality>
        </Region>
      </Regions>
      <Variables Count="2">
  ...
  <Analysis Ver="1">
    ...
    <Step Ver="1">
      ...
      <Size PropType="double" UCat="Time" Unt="s">0.05</Size>
  ...
  <Transfers Count="2">
    <Transfer Ver="1">
      ...
      <Source Ver="1">
        ...
        <Region PropType="string">Plate</Region>
